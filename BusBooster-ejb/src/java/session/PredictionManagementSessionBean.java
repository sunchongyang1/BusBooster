...
public class PredictionManagementSessionBean implements PredictionManagementSessionBeanLocal {
    ...
    public void updateArrivalTime(List<BusData> busDataList) {
        ...
        if(this.calculateDistance(avgLat, avgLon, nextStop.getLatitude(), nextStop.getLongtitude()) < 10 || 
    ...
    public List<Double> getArrivalTime(String busNo, String busStopName) {
        ...
        for(Bus b: busList) {
            ...
            Bus temp = findPreviousBus(b, busStopName);
            if(temp != null) {
